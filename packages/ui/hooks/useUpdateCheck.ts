...
const GITHUB_API = 'https://api.github.com/repos/nipunarora/specplannotate/releases/latest';
      ...
      try {
        ...
        if (previewVersion) {
          ...
          setUpdateInfo({
            ...
            releaseUrl: `https://github.com/nipunarora/specplannotate/releases/tag/v${cleanPreview}`,
